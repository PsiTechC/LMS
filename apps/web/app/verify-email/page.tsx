  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Logo */}
        <div style={{
          width: 52, height: 52, background: "rgba(239,78,36,0.1)", borderRadius: 14,
          display: "flex", alignItems: "center", justifyContent: "center",
          margin: "0 auto 20px", color: "#EF4E24", fontWeight: 800, fontSize: 18,
        }}>XA</div>

        {status === "verifying" && (
          <>
            <div style={{ fontSize: 17, fontWeight: 700, color: "#1C2551", marginBottom: 10 }}>
            ...
            <div style={{
              margin: "28px auto 0", width: 36, height: 36, border: "3px solid #EAECF4",
              borderTop: "3px solid #EF4E24", borderRadius: "50%",
...
function ResendForm() {
  ...
  return (
    <div>
      <div style={{ fontSize: 12, fontWeight: 700, color: "#8b90a7", letterSpacing: 0.5, marginBottom: 8 }}>
      ...
      <input
        ...
        style={{
          ...
          color: "#1C2551", boxSizing: "border-box", outline: "none", marginBottom: 10,
        }}
      ...
      <button
        ...
        style={{
          width: "100%", padding: "10px", background: email.trim() && !loading ? "#EF4E24" : "#D0D3E0",
