...
const PILLARS: { icon: string; title: string; body: string; color: string; href: string }[] = [
  { icon: "▤", title: "Open Programs", body: "Browse cohort-based leadership programs from IIM, ISB & XLRI faculty and enroll in minutes.", color: "#C8A860", href: "/open-programs" },
  { icon: "◎", title: "For Organizations", body: "Run a dedicated cohort for your managers and leaders, with a single dashboard for outcomes.", color: "#182848", href: "/for-organizations" },
  { icon: "◈", title: "Alumni Network", body: "Join 10,000+ leaders across industries who stay connected long after the program ends.", color: "#4A5573", href: "/alumni-network" },
];
...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F5F0", fontFamily: "Poppins,sans-serif" }}>
      ...
      {/* Hero */}
      <div style={{ background: "linear-gradient(135deg,#0f1635 0%,#182848 55%,#0f1635 100%)", padding: "72px 24px 64px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", textAlign: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(200, 168, 96,0.15)", border: "1px solid rgba(200, 168, 96,0.35)", borderRadius: 20, padding: "4px 14px", marginBottom: 22 }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 44 }}>
            <a href="/open-programs" style={{ padding: "12px 26px", background: "#C8A860", borderRadius: 22, color: "#fff", fontSize: 13, fontWeight: 700, textDecoration: "none" }}>Browse Programs →</a>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 24px 64px" }}>
        <div style={{ fontSize: 11, fontWeight: 700, color: "#C8A860", letterSpacing: 1, marginBottom: 8, textAlign: "center" }}>WHERE TO START</div>
        <div style={{ fontSize: 22, fontWeight: 700, color: "#182848", marginBottom: 34, textAlign: "center" }}>Everything Executive Acceleration offers</div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
          {PILLARS.map(p => (
            <a key={p.title} href={p.href} style={{ background: "#fff", borderRadius: 16, border: "1px solid #E6DED0", padding: "26px 24px", boxShadow: "0 1px 6px rgba(24, 40, 72,0.06)", textDecoration: "none", display: "block" }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: "#182848", marginBottom: 8 }}>{p.title}</div>
              <div style={{ fontSize: 12.5, color: "#4A5573", lineHeight: 1.7, marginBottom: 14 }}>{p.body}</div>
